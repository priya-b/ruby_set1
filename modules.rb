...
Sentence.break_words("Have a nice day")
Sentence.sort_words("Coffee")
Sentence.print_first_word("Qwinix Technologies")
Sentence.print_last_word("Era of Internet")
Sentence.sort_sentence("Computers made life easier")
Sentence.print_first_and_last_word_in_a_sentence("Try hard to succeed")
Sentence.print_sorted_first_and_last_word_in_a_sentence("Failure are common")